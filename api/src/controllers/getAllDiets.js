...
const getDietsFromApi = async () => {
    try {
        const response = await axios.get("https://api.spoonacular.com/recipes/complexSearch?apiKey=a27b3ca93fb34726b06c26d7ee03eeb9&addRecipeInformation=true&number=100");
        const { data } = response;
